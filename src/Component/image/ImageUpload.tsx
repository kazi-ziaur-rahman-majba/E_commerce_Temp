...
const ImageUpload: React.FC<ImageUploadProps> = ({ value, onChange }) => {
	...
	return (
		<div className="flex flex-row items-start space-x-3">
			<label htmlFor={`${id}-file-upload`} className="w-[120px] h-[120px] flex items-center justify-center flex-col gap-2 border border-dashed border-[#e6eaed] text-sm rounded-md cursor-pointer hover:border-[#FE9F43] transition-all ease-in-out duration-300 mt-2">
