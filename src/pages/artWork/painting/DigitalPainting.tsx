...
import noImage from "../../../assets/1.png";
...
const DigitalPainting = () => {
  ...
  return (
    <>
      <div
        className="bg-blue-300 p-4 h-64 flex items-center justify-center bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url(${digitalPaint})` }}
      >
        <p className="text-4xl font-bold text-blue-800">Digital Painting</p>
      </div>

      <div className="flex max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto justify-between">
